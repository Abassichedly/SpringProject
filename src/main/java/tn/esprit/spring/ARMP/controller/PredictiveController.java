...
import tn.esprit.spring.ARMP.service.advanced.PredictiveAnalyticsService;
...
public class PredictiveController {
    ...
    public ResponseEntity<Map<String, Object>> predictChurn(@PathVariable long userId) {
        return ResponseEntity.ok(predictiveService.predictChurnRisk(userId));
    }
